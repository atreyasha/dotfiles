...
(defun latex-plus/post-init-company ()
  (spacemacs//latex-setup-company))

(defun latex-plus/init-auctex ()
  (use-package tex
    :defer t
    :init
    (progn
...
(defun latex-plus/pre-init-auctex-latexmk ()
  (spacemacs|use-package-add-hook tex
    :post-config
    (auctex-latexmk-setup)))

(defun latex-plus/init-auctex-latexmk ()
  (use-package auctex-latexmk
    :defer t
    :init (setq auctex-latexmk-inherit-TeX-PDF-mode t)))

(defun latex-plus/post-init-evil-matchit ()
  (add-hook 'LaTeX-mode-hook 'evil-matchit-mode))

(defun latex-plus/post-init-flycheck ()
  (spacemacs/enable-flycheck 'latex-mode))

(defun latex-plus/post-init-flyspell ()
  (spell-checking/add-flyspell-hook 'LaTeX-mode-hook))

(defun latex-plus/init-reftex ()
...
(defun latex-plus/init-lsp-latex ()
  (use-package lsp-latex
    :defer t))

(defun latex-plus/init-math-symbol-lists ()
  (use-package math-symbol-lists
    :defer t))

(defun latex-plus/init-company-math ()
  (use-package company-math
    :defer t))

(defun latex-plus/init-company-auctex ()
  (use-package company-auctex
    :defer t))

(defun latex-plus/init-company-reftex ()
