...
1.  **TODO** Private
    ...
    1.  neomutt
        ...
        1.  need to copy account and breaker pseudo-mailboxes -\> these
            would be cumbersome to copy otherwise

        2.  remove autogenerated comments later on when tracking -\> or
            just format comments and account-related configs in general

        3.  make UZH and UP emails fully archived and delete everything
