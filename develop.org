...
***** use ~autorandr~ for more automatic monitor configuration
***** or alternatively look for another program which only detects without automatically changing -> perhaps just using ~autorandr~ python script installed via ~pip~
***** or perhaps create AUR repository to do this directly
**** I3
***** convert i3-cycle to i3-ipc and port everything to AUR/pypi
...
**** create pacman hooks to update package lists, otherwise use script for all other updates
