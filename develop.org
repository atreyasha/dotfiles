...
****** think about adding workflow to handle spaces, make case unsensitive and parse bibliography codes better (eg. "doran2017does" from "do") as well in =company-reftex-citation-candidates=
