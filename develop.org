...
*** Dotfiles
**** Current
***** system: disable dpms/dim when video is playing: see bug report https://github.com/qutebrowser/qutebrowser/issues/5504
...
***** emacs: fix wrong argument error on =helm-company= post command hook 
**** Long-term
***** emacs
