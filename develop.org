...
*** Dotfiles
**** Current
***** TODO bash/zsh: put aliases in dedicated files for both bash and zsh
***** TODO bash/zsh: add if statements to check for certain commands to reduce hard-coding (eg. ranger and neomutt)
***** bash/zsh: reduce redundant code in bash/zsh and clean workflows up -> would require understanding each line
