...
***** zsh/bash: improve shared history between multiple terminals
****** zsh: =setopt shared_history=, bash: extra prompt commands =history -a, history -c, history -r=
****** zsh/bash: modify up and down keys to reload shell history before searches -> see https://superuser.com/questions/843138/how-can-i-get-zsh-shared-history-to-work/844048#844048
