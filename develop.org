...
** Tasks
*** Dotfiles
***** TODO fine tune installation script for user and root level dotfiles -> think about whether root files even belong with dotfiles and how they should be managed
