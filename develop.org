...
*** Dotfiles
**** Current
***** system: disable dpms/dim when video is playing
***** bash/zsh: organize configurations files into modular sub-files to be sourced by mains -> difficult because of many different functionalities in zsh but should be possible with enough scrutiny
